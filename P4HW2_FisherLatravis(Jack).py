...
#This codes executes after look breaks
print("Done adding employees")
print()
print(f"Total number of employees: {num_em}")
print(f"Total number of regular pay to employees: {total_reg}")
print(f"Total number of overtime pay to employees: {total_ot}")
print(f"Total number of gross pay to employees: {total_gross}")
